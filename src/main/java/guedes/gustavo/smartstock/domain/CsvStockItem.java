package guedes.gustavo.smartstock.domain;
...
public class CsvStockItem {
    ...
    private Integer reorderTheshold;
    ...
    public Integer getReorderTheshold() {
        return reorderTheshold;
    }

    public void setReorderTheshold(Integer reorderTheshold) {
        this.reorderTheshold = reorderTheshold;
    }
